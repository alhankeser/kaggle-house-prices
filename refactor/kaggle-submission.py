'''
DISCLAIMER: 
This script is badly in need of refactoring and is a poor example of scalable programming
practices. Fork at your own risk!
#
Using a basic linear regression with some cleaning and feature engineering beforehand, 
as documented here: https://www.kaggle.com/alhankeser/beginner-eda-and-data-cleaning 
'''
